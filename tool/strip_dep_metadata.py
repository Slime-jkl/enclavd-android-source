...
def strip(path: str, out: str | None = None) -> int:
    ...
    # block_size counts pairs + second size field + magic (16); the first
    # size field sits size_pos - block_size + 16 (verified against real APKs).
    ...
    # patch the EOCD cd_offset to point at the shifted central directory
